  ...
  return (
    <div className="auth-page">
      ...
      <div className={`auth-container ${isSignUp ? "right-panel-active" : ""}`}>
        ...
        <div className="form-container sign-up-container">{isSignUp && children}</div>

        {/* Sign In Form Container */}
        <div className="form-container sign-in-container">{!isSignUp && children}</div>
          ...
          <div className="overlay">
              ...
              <div className="panel-content">
                ...
                <div className="chart-visual">
                  <svg viewBox="0 0 200 100" preserveAspectRatio="none">
                    <path className="chart-path" d="M0 80 Q20 60 40 70 T80 40 T120 55 T160 30 T200 45" />
                  </svg>
                </div>

                <h2>Welcome Back, Trader.</h2>
                <p>
                  The market is moving fast. Sign in to track your portfolio&apos;s performance, review your latest
                  buy/sell signals, and seize today&apos;s opportunities before they pass. Let&apos;s see what&apos;s trending.
                </p>
            ...
            <div className="overlay-panel overlay-right">
              <div className="panel-content">
                ...
                <div className="chart-visual">
                  <svg viewBox="0 0 200 100" preserveAspectRatio="none">
                    <path className="chart-path" d="M0 50 Q30 70 60 40 T100 60 T140 25 T180 45 T200 20" />
                  </svg>
                </div>

                <h2>Don&apos;t Just Watch the Market—Master It.</h2>
                <p>
                  Empower your financial journey with professional-grade tools. Join Market Pulse to unlock advanced
                  heatmaps, set instant price alerts, and make confident moves with real-time signals. Your path to smart
                  trading starts here.
                </p>
